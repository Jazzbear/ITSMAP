...
public class MainActivity extends AppCompatActivity {
    ...
    //buttons
    private Button btnStartBgService, btnStopBgService, btnBindCountingService,
            btnUnbindCountingService, btnGetCount, btnFoo, btnBaz, btnExit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setup all buttons with respective method calls
        ...
        //not that instantiating it this way may produce memory leaks, and that you would
        //probably not do it in onCreate() anyways
