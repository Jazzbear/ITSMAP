...
public class Globals {
    ...
    public static final String STOCK_QUOTE_FILTER_STRING = "&types=quote&filter=companyName,symbol,primaryExchange,latestPrice,latestTime,open,close,changePercent";
